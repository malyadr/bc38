...
export const DISTANCE_VALUES = ['0-10kms', '11-20kms', '21-30kms', '31-40kms']
...
export const STEPPER_TWO_OPTIONS = [
    'Hyderabad',
    'Faridabad',
    'Mumbai',
    'Chandigarh',
...
export const BASE_URL = 'http://localhost:9001/jobs/'
